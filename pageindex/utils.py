...
# Une pièce de procédure courte (PV, avis, convocation…) se cherche et se
# cite comme UNE pièce : les questions réelles désignent des pièces, jamais
# leurs rubriques internes (AFFAIRE, OBJET…). Vérifié sur corpus : l'arbre
# « un nœud par pièce » du dossier Théo donne l'acceptation 9/9, quand les
# pièces sur-découpées (médiane 5 nœuds, jusqu'à 31 pour un bordereau d'une
# page) n'y gagnent rien et coûtent un résumé LLM par nœud.
